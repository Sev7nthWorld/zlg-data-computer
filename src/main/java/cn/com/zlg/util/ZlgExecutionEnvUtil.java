...
import cn.com.zlg.demo.PropertiesConstants;
 ...
 * 微信公众号：zhisheng
 */
public class ZlgExecutionEnvUtil {
    public static ParameterTool createParameterTool(final String[] args) throws Exception {
        return ParameterTool
                .fromPropertiesFile(ZlgExecutionEnvUtil.class.getResourceAsStream(PropertiesConstants.PROPERTIES_FILE_NAME))
